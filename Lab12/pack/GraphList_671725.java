...
public class GraphList_671725 {
    private int vertices;
    private List<Integer>[] adjacencyList;

    public GraphList_671725(int vertices) {
    ...
    public void addEdge(int src, int dest) {
        adjacencyList[src].add(dest); /* your code 1 */ 
        adjacencyList[dest].add(src); // remove this line if directed
    }
